...
Revision date: 2017-01-16
 ...
 -->
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:gml="http://www.iho.int/s100gml/1.0" xmlns:s100_profile="http://www.iho.int/S-100/profile/s100_gmlProfile" xmlns:gml2="http://www.opengis.net/gml/3.2" xmlns="http://www.iho.int/S124/gml/1.0" targetNamespace="http://www.iho.int/S124/gml/1.0" elementFormDefault="unqualified" version="0.0.7">
	<!-- ============================================================================================= -->
...
<xs:element name="S124_FeatureType" type="S124_FeatureTypeType" abstract="true" substitutionGroup="gml2:AbstractFeature"/>
		...
		<xs:complexContent>
			<xs:extension base="S124_FeatureTypeType">
				<xs:sequence>
					...
					<xs:element name="header" type="gml2:ReferenceType" minOccurs="1" maxOccurs="1"/>
				</xs:sequence>
			</xs:extension>
		</xs:complexContent>
	</xs:complexType>
...
<xs:element name="S124_InformationType" type="S124_InformationTypeType" abstract="true"/>
	<xs:complexType name="S124_InformationTypeType" abstract="true">
		...
		<xs:complexContent>
			<xs:extension base="gml:AbstractInformationType">
				<xs:sequence>
					<xs:element name="id" type="MRN" minOccurs="1" maxOccurs="1"/>
					<xs:element name="provides" type="gml2:ReferenceType" minOccurs="0" maxOccurs="1"/>
				</xs:sequence>
			</xs:extension>
		</xs:complexContent>
	</xs:complexType>
		...
		<xs:complexContent>
			<xs:extension base="S124_InformationTypeType">
				<xs:sequence>
					...
					<xs:element name="theWarningPart" type="gml2:ReferenceType" minOccurs="0" maxOccurs="unbounded"/>
				</xs:sequence>
			</xs:extension>
		</xs:complexContent>
	</xs:complexType>
...
(This definition merges the planned S-100 temporal model with the current S-101 DCEG definition of fixed date range.)</xs:documentation>
	...
	<xs:complexType name="DatasetType">
		...
		<xs:complexContent>
			<xs:extension base="gml2:AbstractFeatureType">
				<xs:sequence>
					<xs:element name="DatasetIdentificationInformation" type="gml:DataSetIdentificationType" minOccurs="0">
						<xs:annotation>
							<xs:documentation>Dataset identification information</xs:documentation>
						</xs:annotation>
					</xs:element>
					<xs:element name="DatasetStructureInformation" type="gml:DataSetStructureInformationType" minOccurs="0">
						<xs:annotation>
							<xs:documentation>Dataset structure information</xs:documentation>
						</xs:annotation>
					</xs:element>
					<xs:group ref="gml:Geometry" minOccurs="0" maxOccurs="unbounded">
						<xs:annotation>
...
<!-- treatment of S-100 Information types is provisional, because GML does not have the concept, and they must be modeled as AbstractGML -->
	<xs:complexType name="MemberType">
		...
		<xs:complexContent>
			<xs:extension base="gml2:AbstractFeatureMemberType">
				<xs:sequence>
					<xs:element ref="gml2:AbstractFeature"/>
				</xs:sequence>
				<xs:attributeGroup ref="gml2:AssociationAttributeGroup"/>
			</xs:extension>
		</xs:complexContent>
	</xs:complexType>
