...
class DeliveryAck(Model):
    ...
    """
    def __init__(self, id: str=None, reference_id: str=None, time_of_delivery: str=None, from_id: str=None, from_name: str=None, to_id: str=None, to_name: str=None, ack_result: str=None):
        """
    ...
    def time_of_delivery(self, time_of_delivery: str):
        """
