...
cp MCstaging/mc-ca-chain.pem VIS-1
tar cf - encoder.py export import stm requirements.txt setup.py swagger_client swagger_server testVIS | (cd VIS-1; tar xfBp -)
