...
def get_voyageplan(url, uvid = None, routeStatus = None):
    ...
    return requests.get(url + sub, params=parameters, headers=headers)
...
def subscribe_voyageplan(url, callback, uvid = None):
    ...
    if uvid is None:
        ...
        return requests.post(url + sub, params=parameters, headers=headers)
    parameters={
        'callbackEndpoint': callback,
        'uvid': uvid
    }
...
def unsubscribe_voyageplan(url, callback, uvid = None):
    ...
    if uvid is None:
        ...
        return requests.delete(url + sub, params=parameters, headers=headers)
    parameters={
        'callbackEndpoint': callback,
        'uvid': uvid
    }
...
def post_voyageplan(url, voyageplan, deliveryAckEndPoint = None, callbackEndpoint = None):
    ...
    return requests.post(url + sub, data=voyageplan, params = parameters, headers = headers)
...
def post_area(url, area, deliveryAckEndPoint = None):
    ...
    return requests.post(url + sub, data=area, params = parameters, headers = headers)
...
def post_text(url, text, deliveryAckEndPoint = None):
    ...
    return requests.post(url + sub, data=text, params=parameters, headers=headers)
...
def send_ack(endpoint, id = 'urn:mrn:'):
    ...
    sub='/acknowledgement'
    with open('export/dummy.txt', 'w') as f:
        f.write(json.dumps(payload))
    return requests.post(endpoint + sub, json=payload)
...
def sendpcm(body):
    ...
    return requests.post(url + sub, headers=headers, data=body)
